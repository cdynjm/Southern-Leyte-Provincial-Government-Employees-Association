                                ...
                                <div className="flex flex-col gap-3 rounded-md border p-3">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => updateForm.setData('deduct_amount', e.target.value === '' ? '' : Number(e.target.value))}
                                        />
                                    </div>
                                </div>
                            )}
                                ...
                                <TableRow key={fa.encrypted_id}>
                                    ...
                                    <TableCell className="py-[6px]">
                                        <div className="flex items-center justify-center gap-2">
                                            <Button variant="secondary" className="text-[11px]" size="icon" onClick={() => editFinancialAccount(fa)}>
