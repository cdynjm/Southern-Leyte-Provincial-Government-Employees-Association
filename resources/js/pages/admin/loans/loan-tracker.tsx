                                ...
                                <div
                                    ...
                                    className={
                                        trackersState.length > 1
                                            ? 'grid grid-cols-1 gap-4 lg:grid-cols-[6fr_6fr_1fr]'
                                            : 'grid grid-cols-1 gap-4 lg:grid-cols-[6fr_6fr]'
                                    }
                                >
                                    {/* Officer Select */}
                                    ...
                                    {/* Description Input */}
                                    <Select value={tracker.description} onValueChange={(val) => updateDescription(index, val)}>
                                        <SelectTrigger className="w-full">
                                            <SelectValue placeholder="Select Description" />
                                        </SelectTrigger>
                                        <SelectContent>
                                            {['ENCODER', 'VALIDATOR', 'APPROVER'].map((role) => (
