...
import { type Employees, type LoanAmortization, type Paginated, type User } from '@/types';
...
export default function LoanEncoder({ employees, search, borrowers, auth }: LoanEncoderProps) {
